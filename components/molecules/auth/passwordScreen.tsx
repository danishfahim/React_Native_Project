...
import { PASSWORD_RESET_OpTION } from '@/constants/appRoute'
        ...
        <PageWraper>
            <View className=' '>
                ...
                <View className='items-center '>
                    ...
                    <View className='h-72' />
                    <TouchableOpacity onPress={() => router.push(PASSWORD_RESET_OpTION)} className="items-center mx-auto flex-row gap-4">
                        <Text>Not You?</Text>
                        <IconLable
