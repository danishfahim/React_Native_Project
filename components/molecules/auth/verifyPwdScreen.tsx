...
import { VERIFY_OTP } from '@/constants/appRoute'
    ...
    <PageWraper>
      <View className=' '>
        ...
        <View className='items-center '>
          ...
          <SecureCodeInput numberOfDigits={8} placeholder='*****' secureTextEntry={true} onChangeText={() => console.log('i am text')} />


          {/* <PrimaryButton title="Sign Up" handleClick={() => router.push(FORGOT_PASSWORD)} customClass="mt-8" /> */}
          <View className='h-5' />
          <TouchableOpacity onPress={() => router.push(VERIFY_OTP)} className="items-center mx-auto flex-row gap-4">
...
export default VerifyPwdScreen 